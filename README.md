...
# The Data Set 
The dataset used in this analysis was obtained directly from the official websites of Coursera and Udemy. These datasets include publicly available raw financial reports such as income statements, balance sheets and cash flow statements, published for the fiscal years 2021, 2022 and 20223. I applied ETL (Extract, Transform, Load) processes, utilizing tools like Power BI to efficiently extract, clean, transform, and load the data. This preparation ensured the datasets were ready for analysis and visualization to enable meaningful comparison and accurate insight generation.
